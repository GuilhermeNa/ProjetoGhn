...
public class BarChartMapperDespesaAdmUseCase extends ManipulaBarChartResourceExt {
    private final List<DespesaAdm> dataSetResource;

    public BarChartMapperDespesaAdmUseCase(@NonNull ResourceData resource) {
        this.dataSetResource = resource.getDataSetDespesaAdm();
    }
    ...
    private void usaHashMapCom12PosicoesParaSepararOsValoresMensalmente(@NonNull final HashMap<Integer, BigDecimal> hashMap) {
        for (DespesaAdm d : dataSetResource) {
            final int keyMes =
