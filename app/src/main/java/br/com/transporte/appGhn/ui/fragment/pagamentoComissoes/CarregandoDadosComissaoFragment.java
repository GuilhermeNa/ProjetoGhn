...
import br.com.transporte.AppGhn.databinding.FragmentCarregandoDadosComissaoBinding;
import br.com.transporte.appGhn.util.AnimationUtil;

public class CarregandoDadosComissaoFragment extends Fragment {
    private FragmentCarregandoDadosComissaoBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentCarregandoDadosComissaoBinding.inflate(getLayoutInflater());
    ...
    public void finaliza() {
        if (animacaoDeEntradaTerminou) {
            animacaoDeSaida(() -> {
                ...
                NavDirections direction = CarregandoDadosComissaoFragmentDirections.actionNavCarregaDadosToNavComissoes();
