...
public class SolicitaParcelaFrotaUseCase extends BuscaData {
    public SolicitaParcelaFrotaUseCase(FragmentDesempenhoRepository repository) {
        super(repository);
    }
    ...
    public LiveData<ResourceData> run(@NonNull final DataRequest dataRequest) {
        ...
        if (buscaTodos) {
            return repository
                    .buscaDespesasSeguroFrotaPorAnoEOuCavaloIdParaFragmentDesempenho(
