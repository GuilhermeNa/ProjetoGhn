...
public class CustoDeAbastecimentoRepository {
    ...
    public LiveData<Resource<List<CustosDeAbastecimento>>> buscaAbastecimentos() {
        mediator.addSource(buscaAbastecimentos_room(),
                abastecimentos -> mediator.setValue(new Resource<>(abastecimentos, null)));
        return mediator;
    }
    ...
    public LiveData<List<CustosDeAbastecimento>> buscaAbastecimentosPorCavaloIdENaoArmazenaEmCache(final long cavaloId) {
        return buscaAbastecimentosPorCavaloId_room(cavaloId);
    }
