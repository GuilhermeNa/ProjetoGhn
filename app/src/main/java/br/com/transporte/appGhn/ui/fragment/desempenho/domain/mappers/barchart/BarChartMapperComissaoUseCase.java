...
public class BarChartMapperComissaoUseCase extends ManipulaBarChartResourceExt {
    private final List<Frete> dataSetResource;

    public BarChartMapperComissaoUseCase(@NonNull ResourceData resource) {
    ...
    private void usaHashMapCom12PosicoesParaSepararOsValoresMensalmente(@NonNull final HashMap<Integer, BigDecimal> hashMap) {
        for (Frete f : dataSetResource) {
            ...
            final BigDecimal valor = f.getComissaoAoMotorista();
