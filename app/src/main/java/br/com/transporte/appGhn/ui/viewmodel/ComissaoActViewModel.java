...
public class ComissaoActViewModel extends ViewModel {
    ...
    public List<CustosDeSalario> getListaSalarioComFiltro(){
        return new ArrayList<>(armazenaSalario.getDataSetComFiltroAplicado(dataInicial, dataFinal));
    }
...
class ComissaoViewModelDataSetSalario{
    ...
    public List<CustosDeSalario> getDataSetComFiltroAplicado(LocalDate dataInicial, LocalDate dataFinal) {
        final List<CustosDeSalario> salarioFiltrado =
                FiltraSalario.listaPorData(dataSetBase, dataInicial, dataFinal);
        Collections.reverse(salarioFiltrado);
