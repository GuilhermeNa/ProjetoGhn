...
public class BarChartMapperDespesaCertificadoUseCase extends ManipulaBarChartResourceExt {
    private final List<DespesaCertificado> dataSetResource;

    public BarChartMapperDespesaCertificadoUseCase(@NonNull ResourceData resource) {
        this.dataSetResource = resource.getDataSetDespesaCertificado();
    }
    ...
    private void usaHashMapCom12PosicoesParaSepararOsValoresMensalmente(@NonNull final HashMap<Integer, BigDecimal> hashMap) {
        for (DespesaCertificado d : dataSetResource) {
            final int keyMes =
