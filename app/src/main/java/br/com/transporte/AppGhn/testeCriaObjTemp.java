...
//---------------------------------------------------------------------------------------------
    ...
    static class ConfiguraObjetosQuandoBuscaAnual {
        ...
        private static void despesasSeguro(List<Parcela_seguroFrota> listaAnual, TipoDespesa tipo) {
            List<Parcela_seguroFrota> lista = FiltraParcelasSeguro.listaPorTipo(listaAnual, tipo);
            lista = FiltraParcelasSeguro.listaPorStatusDePagamento(lista, true);

            BigDecimal valor;
            for (ObjetoTemporario_representaCavalo obj : objTemporarioDao.listaTodos()) {

                List<Parcela_seguroFrota> dataSet = FiltraParcelasSeguro.listaPeloCavaloId(lista, obj.getId());
        ...
        private static void lucro() {
            ...
            List<Parcela_seguroFrota> listaParcelaSeguro = FiltraParcelasSeguro.listaPorAno(parcelaDao.listaTodos(), ano);
            ...
            for (ObjetoTemporario_representaCavalo obj : objTemporarioDao.listaTodos()) {
                ...
                List<Parcela_seguroFrota> dataSetParcelaSeguro = FiltraParcelasSeguro.listaPeloCavaloId(listaParcelaSeguro, obj.getId());
    ...
    private static class ConfiguraObjetosQuandoBuscaMensal {
        ...
        private static List<Parcela_seguroFrota> configuraListaConformeParametrosBuscados_seguro(List<Parcela_seguroFrota> listaAnual, int mes, TipoDespesa tipo) {
            List<Parcela_seguroFrota> lista = FiltraParcelasSeguro.listaPorMes(listaAnual, mes);
        ...
        public static void lucro() {
            ...
            List<Parcela_seguroFrota> listaParcelaSeguro = FiltraParcelasSeguro.listaPorAno(ConfiguraObjetosQuandoBuscaAnual.parcelaDao.listaTodos(), ano);
    ...
    private static class ConfiguraRateioDeDespesasIndiretasQuandoBuscaAnual {
        ...
        private static void despesasSeguroIndireto(List<Parcela_seguroFrota> listaAnual) {
            ...
            for (ObjetoTemporario_representaCavalo obj : objTemporarioDao.listaTodos()) {
                List<Parcela_seguroFrota> dataSet = FiltraParcelasSeguro.listaPeloCavaloId(lista, SEM_REF_CAVALO);
        ...
        private static List<Parcela_seguroFrota> configuraListaConformeParametrosBuscado_rateioMensalSeguro(List<Parcela_seguroFrota> listaAnual) {
            List<Parcela_seguroFrota> lista = FiltraParcelasSeguro.listaPorTipo(listaAnual, INDIRETA);
            lista = FiltraParcelasSeguro.listaPorStatusDePagamento(lista, true);
            return lista;
        }
        ...
        public static void lucro() {
            ...
            for (ObjetoTemporario_representaCavalo obj : objTemporarioDao.listaTodos()) {
                ...
                List<Parcela_seguroFrota> dataSetParcelaSeguro = FiltraParcelasSeguro.listaPeloCavaloId(listaParcelaSeguro, SEM_REF_CAVALO);
                BigDecimal parcela = CalculoUtil.somaParcelasSeguro(dataSetParcelaSeguro);
    ...
    private static class ConfiguraRateioDeDespesasIndiretasQuandoBuscaMensal {
        ...
        public static void lucro() {
            ...
            List<Parcela_seguroFrota> listaParcelaSeguro = FiltraParcelasSeguro.listaPorAno(ConfiguraObjetosQuandoBuscaAnual.parcelaDao.listaTodos(), mes);
            listaParcelaSeguro = FiltraParcelasSeguro.listaPorStatusDePagamento(listaParcelaSeguro, true);
            listaParcelaSeguro = FiltraParcelasSeguro.listaPorTipo(listaParcelaSeguro, INDIRETA);
