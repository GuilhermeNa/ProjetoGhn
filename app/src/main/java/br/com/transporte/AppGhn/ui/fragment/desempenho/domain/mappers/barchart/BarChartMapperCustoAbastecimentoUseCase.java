...
public class BarChartMapperCustoAbastecimentoUseCase extends ManipulaBarChartResourceExt {
    private final List<CustosDeAbastecimento> dataSetResource;

    public BarChartMapperCustoAbastecimentoUseCase(@NonNull ResourceData resource) {
