...
import br.com.transporte.AppGhn.databinding.FragmentCarregandoDadosCertificadoBinding;
import br.com.transporte.AppGhn.util.AnimationUtil;

public class CarregandoDadosCertificadoFragment extends Fragment {
    public static final String MSG_DADOS_CARREGADOS = "Tudo Pronto!";
    private FragmentCarregandoDadosCertificadoBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentCarregandoDadosCertificadoBinding.inflate(getLayoutInflater());
    ...
    public void finaliza() {
        if (animacaoDeEntradaTerminou) {
            animacaoDeSaida(() -> {
                ...
                NavDirections direction = CarregandoDadosCertificadoFragmentDirections.actionNavCarregaDadosCertificadoToNavCertificadosDiretos();
