...
public class FormularioCertificadosFragment extends FormularioBaseFragment {
    ...
    private void tentaCarregarArguments() {
        final FCertificadoCarregaArgumentsExt carregaArguments = new FCertificadoCarregaArgumentsExt(getArguments());
    ...
    private void carregaListaDeCertificados() {
        List<String> listaCertificados = FCertificadoGetListaCertificadosExt.run(viewModel.getTipoDespesa());
    ...
    private void configuraDropDownMenuDePlacas() {
        AutoCompleteTextView campoPlacaAutoComplete = binding.fragFormularioCertificadoRefCavalo;
    ...
    public void alteraUiParaModoEdicao() {
        ...
        Objects.requireNonNull(((AppCompatActivity) requireActivity())
                        .getSupportActionBar())
                .setTitle(TITULO_APP_BAR_EDITANDO);
    }
    ...
    public void alteraUiParaModoCriacao() {
        ...
        Objects.requireNonNull(((AppCompatActivity) requireActivity())
                        .getSupportActionBar())
                .setTitle(TITULO_APP_BAR_CRIANDO);
    }
