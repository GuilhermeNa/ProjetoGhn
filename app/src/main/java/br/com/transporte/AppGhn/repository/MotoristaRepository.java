...
public class MotoristaRepository {
    ...
    public LiveData<Resource<List<Motorista>>> buscaMotoristas() {
        mediator.addSource(buscaMotoristas_room(), new Observer<List<Motorista>>() {
            @Override
            public void onChanged(List<Motorista> listaMotoristas) {
                mediator.setValue(new Resource<>(listaMotoristas, null));
            }
        });
        return mediator;
    }
    ...
    private void adicionaMotorista_room(
        ...
        task.solicitaAdicao(dao, motorista, new AdicionaMotoristaTask.TaskCallback() {
            @Override
            public void adicaoFinalizada(Long idNovoMotorista) {
